...
for name in "${names[@]}"; do
    ...
    /home/mahdi/anaconda3/lib/python3.11/site-packages/HTSeq-2.0.5-py3.11-linux-x86_64.egg/EGG-INFO/scripts/htseq-count -i gene_name "/mnt/d/NGS/Samples/P3/Aligned/${CleanedName}_sorted.sam" "/mnt/d/NGS/References/gencode.v38.annotation.gtf" > "/mnt/d/NGS/Samples/P3/Aligned/${CleanedName}_sorted.count"
